...
Achieved occupancy is the number of active warps per clock cycle divided by the maximum warps per streaming multiprocessor. In other words, it is the percentage of used up GPU computational resources. It is one of the key factors influencing every GPU application, because when the GPU is not occupied to its maximum, it means, that there are resources being wasted. However, maximum occupancy doesn't always lead to the best results, because other areas of optimization, such as memory access, atomic operation stalls or cache hit rate may outperform it.
...
\addplot [draw=none, fill=mblue] coordinates {(8x8, 248.6483134328) (16x16, 204.2498059702) (32x32, 335.6116915423)};

\addplot [draw=none, fill=mred] coordinates {(8x8, 320.7663681592) (16x16, 191.187199005) (32x32, 587.1658457711)};

\addplot [draw=none, fill=myellow] coordinates {(8x8, 168.2858507463) (16x16, 147.3512139303) (32x32, 190.377681592)};

\addplot [draw=none, fill=mgreen] coordinates {(8x8, 734.4752835821) (16x16, 642.0554825871) (32x32, 1264.044079602)};
...
\addplot [draw=none, fill=mblue] coordinates {(8x8, 17.818341791) (16x16, 16.6247671642) (32x32, 18.2170721393)};

\addplot [draw=none, fill=mred] coordinates {(8x8, 8.1987296517) (16x16, 5.8072519403) (32x32, 16.2695338308)};

\addplot [draw=none, fill=myellow] coordinates {(8x8, 24.8028029851) (16x16, 24.5568875622) (32x32, 23.9845751244)};

\addplot [draw=none, fill=mgreen] coordinates {(8x8, 29.0125238806) (16x16, 27.0477900498) (32x32, 33.8991532338)};
...
\addplot [draw=none, fill=mblue] coordinates {(8x8, 15.6227313433) (16x16, 15.5606298507) (32x32, 22.6902890547)};

\addplot [draw=none, fill=mred] coordinates {(8x8, 14.9011532338) (16x16, 9.5073046269) (32x32, 27.3350124378)};

\addplot [draw=none, fill=myellow] coordinates {(8x8, 17.8485542289) (16x16, 20.8229238806) (32x32, 24.8877955224)};

\addplot [draw=none, fill=mgreen] coordinates {(8x8, 37.0351412935) (16x16, 31.5296278607) (32x32, 52.1291577114)};
...
\addplot [draw=none, fill=mblue] coordinates {(8x8, 1683607) (16x16, 2638143) (32x32, 731513)};

\addplot [draw=none, fill=mred] coordinates {(8x8, 925513) (16x16, 1445978) (32x32, 498445)};
